    ...
    <footer className="relative w-full bg-brand-navy border-t border-brand-golden-yellow/20 overflow-hidden py-24">
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12 relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="flex items-center gap-2 md:gap-4 font-brand-small font-bold text-sm uppercase tracking-widest">
          <SocialIcon url="https://www.linkedin.com/school/vidya-vikas-mandals-shree-damodar-college-of-commerce-&-economics-margao/" bgColor="transparent" className="hover:scale-110 hover:brightness-125 transition-all" style={{ height: 40, width: 40 }} />
          <SocialIcon url="https://www.facebook.com/p/VVMs-Shree-Damodar-College-100064036413651/" bgColor="transparent" className="hover:scale-110 hover:brightness-125 transition-all" style={{ height: 40, width: 40 }} />
          <SocialIcon url="https://www.instagram.com/damodar_college/" bgColor="transparent" className="hover:scale-110 hover:brightness-125 transition-all" style={{ height: 40, width: 40 }} />
        </div>
      </div>
